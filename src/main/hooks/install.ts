...
const renderHelperSource = (): string => `// Generated by Arc Work. Do not edit.
...
const mcpToken = process.env[${JSON.stringify(ArcEnvTags.mcpToken)}]
const arcDbPath = process.env[${JSON.stringify(ArcEnvTags.dbPath)}]
